...
export class Relayer implements IRelayer {
  ...
  public constructor(credentials: RelayerParams) {
    ...
    if (isActionCredentials(credentials)) {
      ...
      throw new Error(
        `Missing credentials for creating a Relayer instance. If you are running this code in an Action, make sure you pass the "credentials" parameter from the handler to the Relayer constructor. If you are running this on your own process, then pass an object with the "apiKey" and "apiSecret" or "accessToken" generated by the relayer.`,
      );
    }
  }

  public getApiKey(): string {
    return this.relayer.getApiKey();
  }

  public getAccessToken(): Promise<string> {
    return this.relayer.getAccessToken();
  }
